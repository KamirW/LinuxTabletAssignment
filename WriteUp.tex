...
Installing the Android SDK Platform Tools is the first step to rooting the device. These are a set of tools that allow a user to interact with the Android
